...
max_features = 200000 # max amount of words considered
max_len = 300 #maximum length of text
...
def build_model():
    ...
    model.compile(optimizer=Adam(lr=0.0025), loss=sparse_categorical_crossentropy)
    return model
...
history = model.fit(X_train, y, batch_size = 512 * 4, epochs = 100,
